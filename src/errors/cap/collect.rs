...
use crate::errors::cap::error::CapacityError;
use crate::errors::cap::traits::{FixedCap, RemainingCap};
use crate::errors::types::SizeHint;

#[cfg(doc)]
use crate::errors::cap::CapacityErrorKind;
...
/// from [`CollectError::iterator`], [`CollectError::collected`], and any
/// overflowing items.
///
/// # Examples
///
/// ```rust
/// # use collect_failable::errors::cap::CapacityError;
...
impl<I: Iterator, C> CollectError<I, C, CapacityError<I::Item>> {
    ...
    ///
    /// ```rust
    /// # use collect_failable::errors::cap::{CapacityError, CapacityErrorKind};
    /// # use collect_failable::errors::types::SizeHint;
    /// # use collect_failable::errors::CollectError;
